...
client.user.setUsername('Killer Disco')
});
...
module.exports.func = function (bot, message, guild) {
    if (!msg.mentions.users.first()) return msg.channel.send(":warning: Vous devez mentionner quelqu'un.");
    let r = rn({
        min: 0,
        max: hug.length - 1,
        integer: true
